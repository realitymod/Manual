...
* Os veículos podem ser reabastecidos e reparados no depósito de suprimentos. Ou use a queda de reparo que qualquer caminhão de logística pode derrubar. Aeronaves e helicópteros são automaticamente consertados e rearmados em seu local de spawn.
...
* Quando os veículos sofrerem muito dano, eles podem se tornar incapazes de se mover ou utilizar sua turret até que sejam totalmente consertados.
...
* Pilotos e artilheiros podem dar **zoom** na sua visão pressionando a tecla de fumaça pop \(**X** \). Alguns Pilotos de tanque devem primeiro mudar para a visão do comandante.
* A maioria dos tanques e IFVs pode usar **ótica térmica** além de suas visualizações normais. Você pode alternar para o modo térmico usando o menu de rádio secundário \(**T** \) e selecionando **“DAY / THERMAL”.** Alguns também permitem alternar entre variações térmicas como WHOT / BHOT.
...
* Você precisa reduzir sua velocidade com antecedência até que você possa ficar nivelado sem cair do céu \(cerca de 40% de potência \) com a velocidade do stall sendo diferente para cada aeronave. \(Você pode encontrar a velocidade de tenda de sua aeronave simplesmente subindo e desacelerando sua aeronave até ela começar a perder o controle e cair, mas fazê-la alta significa que você pode recuperar o controle soltando o acelerador e apontando o seu nariz para baixo, então fique acima da velocidade de stall durante a aterrissagem, até que suas rodas atinjam o chão. \)
* Quando você está nessa velocidade, você deve começar sua abordagem.
...
* Uma vez que você tenha tocado o chão, puxe o bastão para desacelerar os planos.
