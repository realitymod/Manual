...
Mais importante, você deve ** juntar-se a um esquadrão **. Alguns servidores até reforçam, kikando jogadores sem squad após um período de aviso. O jogo é de longe o mais divertido de se jogar em um esquadrão funcional. Se você precisar de ajuda, apenas ** pergunte aos jogadores do seu time ** o que fazer. Se possível, use Mumble. É comumente usado em relações públicas. Jogar PR: BF2 sem microfone não lhe dará a experiência completa, por isso é um investimento inteligente. Se ninguém responder, tente entrar em outro time ou use o chat geral. Há muitos membros da comunidade em atividade que recebem novos jogadores e dão uma ajuda. Esperamos que você tenha uma compreensão básica do BF2 quando se trata de navegar pelo menu do jogo, como seleção de placar, mapa e kit. Você sempre pode inicializar o BF2 e fazer o tutorial para se familiarizar com sua interface. Este manual irá focar nas diferenças com o BF2.**
...
* ** The commander rally point **. Esse RP só pode ser colocado pelo comandante, desde que os líderes de vários esquadrões estejam nas proximidades do CO. No mapa, esse será um ponto de reunião com um "C" ao lado dele.
* **Deployable forward operating base \(FOB\) or hideouts** pode ser usado por toda a equipe para spawnar, mas deve ser construído antes de se tornar operacional. No mapa, ele aparecerá como um ponto de spawn com um triângulo verde. Ele fica online 90 segundos depois de ser construído. Ele se torna inviolável por 30 segundos se 1 inimigo estiver a 10 m, 2 inimigos em 50 m, 4 inimigos em 100 m ou 8 inimigos em 150 m. [\(veja estruturas implementáveis\)](the_squad_leader.md#deployable-structures)
* No modo de jogo de insurgência, a equipe rebelde defensora pode aparecer nos ** weapons caches ** que não foram revelados ao inimigo, isso é chamado de cache desconhecido. Este spawn também é desativado se inimigos se aproximarem do FOB.
...
> ![](../assets/acv.png)
>
> Veículo de Comando Blindado \(ACV\) encontrado apenas em base principal.

* Alguns mapas apresentam ** parachute spawns ** spawns de pára-quedas onde um ataque aéreo é simulado. Estes serão visualizados movendo os marcadores de geração no minimapa. Escolha um e não se esqueça de ** pressione 9 para abrir o pára-quedas!**

## _Interface no Jogo \(HUD\)_ {#hud}
...
* **O Medico** pode ver no HUD um icone de cura ao curar um soldado, este icone aparece no canto inferior direito. A infantaria pode observar da mesma forma quanto tempo até que a desdobramento esteja concluída.
...
* Somente veículos usam um ** mini-mapa ** permanente no HUD. A sobreposição completa do mapa está disponível para todos.
* ** O mapa e a layer atual ** podem ser visualizados na parte superior da tela ao abrir o mapa.
* Usando a pequena seta, você verá a ** sobreposição de informações de ativos do mapa atual ** de todos os veículos que estão no mapa, incluindo os tempos de spawn de veículos aliados.

> ![](../assets/assets.png)
>
> Sobreposição de informações de ativos do mapa atual.

* **Os tickets restantes ** de sua equipe e o tempo restante só podem ser vistos na tela de seleção. Os tickets inimigos não são exibidos.
* ** Supressão ** acontece quando você está sob fogo próximo por rifles, armas pesadas ou explosões próximas. A tela aparecerá mais escura e ficará borrada como se estivesse tremendo. Este efeito simula a capacidade reduzida de retornar fogo efetivo enquanto é suprimido pelo inimigo**.
...
* Sua arma irá se desviar e se tornar imprecisa para atirar com base na quantidade de movimento que você faz. Para ter uma indicação dessa imprecisão, há um indicador de desvio ** logo acima da bússola. Quanto mais amplo for esse indicador, mais desvios você terá.
* ** O sistema automático de localização de mapas ** foi removido da infantaria. Veículos aéreos ainda podem ser vistos.
* Os oficiais podem enviar um relatório de ** contato ** para o comandante ou usar seu rádio para colocar manualmente um marcador no mapa da equipe. Soldados normais só podem gritar um aviso genérico quando localizam unidades inimigas.
* ** A roda de rádio \(default: Q & T\)** contém itens com duas funções. Clicar com o botão esquerdo ** “RECARREGAR / CESSAR FOGO” ** diz às pessoas ao seu redor que você está recarregando, enquanto um clique com o botão direito diz a elas para parar com o fogo-amigo. O mesmo princípio se aplica a ** “GO, GO, GO / FALL BACK” ** e outros itens do menu.
* Você pode ** orientar-se ** no mapa usando o elemento de direção que você encontrará em torno do ícone do seu jogador.
* Embora equipada com armas ou equipamentos específicos, a principal ** comunicação via rádio ** é substituída por um pequeno menu sensível ao contexto. Ao segurar um curativo ou a bolsa de primeiros socorros, você pode usar o comando “FIRST AID” para informar aos jogadores próximos que você deseja curá-los. Muitos equipamentos e algumas armas usam menus contextuais.

> ![](../assets/commorose.png)
>
> Roda de Comando quando pressionar Q.

## _Gestão dos Pontos de Vida_ {#health-management}

Armas no Project Reality são altamente letais e é apenas uma questão de tempo até você ser baleado e começar a sangrar. Embora o HUD no PR não contenha uma barra de saúde, uma vez que sua saúde fica abaixo de 75%, haverá sinais sonoros e visuais para avisá-lo, como uma visão sanguinolenta enquanto tosse ou grita.

### Healing

Se seus ferimentos não forem tratados, você sangrará lentamente até a morte. Para evitar isso, você tem duas maneiras de se curar. Quase todos os kits incluem um ** field dressing ** que é selecionado pressionando a tecla apropriada ou passando por sua seleção de armas. Pressionar o botão esquerdo do mouse joga o curativo no chão. Dentro de um segundo ou dois, o curativo de campo desaparecerá e o jogador ao lado recuperará 25% de sua saúde total.

Como a maioria dos kits possui apenas um ou dois curativos, a melhor maneira de recuperar a saúde é ser tratado por um médico. ** Medics ** são capazes de curar completamente um jogador usando um ** first aid kit ** e podem ser chamados para a sua posição usando a tecla de rádio “Q” e selecionando “Need Medic”. O médico selecionará o kit de primeiros socorros pressionando a tecla numérica apropriada ou passando por sua seleção de armas. No entanto, ao contrário do BF2, o médico não pode simplesmente jogar o kit de primeiros socorros no chão, mas deve segurá-lo em suas mãos, tocar o jogador a ser curado e, em seguida, pressionar o botão esquerdo do mouse. Um som simulando bandagens sendo rasgadas indicará que os primeiros socorros estão sendo aplicados. Para ser completamente curado leva cerca de 15 segundos, então certifique-se de fazer isso em um local seguro.
...
* Suicide: **15 segundos**
* Civil sendo capturado: **90 segundos**
* Civil Morto violando ROE: **120 segundos por Civil**
* Cache de armas próprio destruído: **300 segundos**

Para selecionar um ponto de spawn, abra o mapa de spawn e selecione um local aplicável. Quando estiver satisfeito com esse local de spawn, você deverá clicar no botão ** Done ** no canto inferior direito da tela do mapa para voltar ao jogo. Apenas esperando o cronômetro expirar ou clicando no botão &lt; Enter &gt; não vai automaticamente reaparecer. Se você vir um número muito grande no timer, como 5999, você não clicou em Concluído.

## _Logística_ {#logistics}

Não importa se você está com pouca munição e precisa se rearmar, quer um novo kit ou simplesmente quer construir implantáveis, a logística mantém sua equipe viva.
...
* **Ammo bags** - Estes podem ser encontrados no rifleman, militante, guerreiro e alguns kits insurgentes e devem ser lançados \(Botão esquerdo do mouse\) no chão, para você ou outros soldados poderem se rearmar, ou em implantáveis \(tow, aa, mortars\) para remuniciar os mesmos. 
* **Ammo boxes** - Derrubado por veículos leves transportados, APCs e IFVs.
* **Light/Heavy supply crates** - Mais informações no [next section](the_basics.md#crates)
* **Weapons caches** - Disponível apenas para insurgentes
* **Vehicle depot** - Presente em todas as bases principais, também te cura
...
Outra coisa a se notar é que o reabastecimento não é instantâneo, mas leva alguns segundos, dependendo da fonte de munição, bem como a quantidade de munição que você precisa ressuplicar. Além disso, se você não estiver se rearmando, confirme se as caixas de suprimento Light / Heavy são realmente suas, rearmando de ** caixas de suprimento inimigas ** não é possível.

### _Supply Crates_ {#crates}

Existem dois tipos de caixas de suprimento em PR: BF2 - Caixa de Suprimento leve \(light\) e Caixa de Suprimento pesada \(Heavy\). Enquanto ambos permitem remuniciar os jogadores e construir implementáveis, uma caixa leve é o equivalente a metade da Caixa de Suprimentos Pesada, o que significa que você precisará de duas caixas de suprimento leve onde apenas uma caixa de suprimento pesado é necessária. Para saber mais sobre emplacements implantáveis, consulte o capítulo [Deployable Structures.\)](the_squad_leader.md#deployable-structures)

> ![](../assets/largecrate.png)![](../assets/smallcrate.png)
>
> _Aqui você pode ver o engradado de suprimento pesado à esquerda e a versão leve à direita._
...
Light Supply Crate pode ser transportado por:
...
A propriedade da caixa é representada pela exibição da bandeira no topo da caixa.

### Repair Drop

Os caminhões de logística também têm a capacidade de soltar uma estação de reparo. Eles são necessários para reparos em campo em veículos que estão muito danificados e não podem se mover.
...
Uma posição de Morteiros que pode fornecer suporte indireto a longas distâncias. Todas as facções podem disparar rondas altamente explosivas. As forças convencionais e a milícia também podem usar explosões de ar e fumaça. Morteiros não podem ser construídas em mapas menores que 2km.
...
4. ** A escala de cada quadrícula ** quadrada é exibida no canto inferior direito do mapa. Um mapa de 1 km será indicado por um esquadrão de 75 metros, 150 metros por 2 km e 300 metros por um mapa de 4 km. Você pode estimar facilmente as distâncias no mapa usando os quadrados da grade. A tela de esquadrões do líder de esquadra também exibe a distância aproximada de seu marcador de esquadrão atual abaixo do mapa do campo de batalha.  
...
Existem muitos tipos de veículos em PR: BF2 usado como classificação. Isso nem sempre está diretamente de acordo com a contraparte do Real Life devido a razões de jogabilidade. A lista a seguir mostra as principais classes de veículos em PR: BF2:
...
* **Veículos civis:** PR:BF2’s as forças insurgentes têm acesso a uma gama de carros civis e técnicos montados com metralhadoras, foguetes e rifles SPO-9 sem recuo. Eles também têm um flatbed com uma arma AA montada, caminhões-bomba e carros-bomba em seu arsenal. 
...
* **Armored Personnel Carrier \(APC\):** grandes veículos blindados mais frequentemente armados com armamento pesado. Muitas vezes não possuem a força para derrotar outros alvos blindados pesados, como IFVs e tanques, mas são os melhores de todos os tipos de veículos para auxiliar a infantaria. Pode caber 2 crewman \(motorista e artilheiro \) e até 6 passageiros soldado.

![](../assets/apc.png)

* **Infantry Fighting Vehicle \(IFV\):** Melhor armado e mais forte que a maioria dos APCs com muitas vezes capacidades para derrotar alvos blindados pesados usando mísseis AT. Nem sempre são capazes de transportar infantaria. Sob esta categoria muitas vezes também sao utilizados como veículos de reconhecimento.
...
* **Tank:** Nosso mais pesado dos veículos blindados. Eles vêm equipados com armamento AP, HE e COAX.

![](../assets/tank.png)

* **Anti-Air Vehicle:** Estes são geralmente veículos blindados leves com apenas a capacidade de derrubar aviões e helicópteros inimigos. Eles podem usar mísseis e / ou armas pesadas.

![](../assets/aavehicles.png)

* **Boat:** PR:BF2 tem uma variedade de barcos tanto armados quanto desarmados.

![](../assets/boats.png)

* **Transport Helicopter:** Estes helicópteros geralmente vêm equipados com Armas de porta para a infantaria montada usar.Eles também são capazes de soltar caixas de suprimentos pesados. Existem helicópteros de transporte leve, médio e pesado. Veja a seção em Crates de Fornecimento para ler sobre qual variante tem quais caixas disponíveis para ele.

![](../assets/transheli.png)

* **Attack Helicopters:** Esses helicópteros vêm equipados com metralhadora e uma variedade de foguetes e mísseis. Existem variantes leves, médias e pesadas. Helicópteros Recon com a capacidade de prender alvos e usar suas câmeras térmicas também se enquadram nessa categoria em PR: BF2. Eles nem sempre estão armados.

![](../assets/attackhelis.png)

* **Jets:** PR:BF2 tem uma grande variedade de jatos. Há jatos de ataque leves e pesados, jatos de combate, bombardeiros e caças-bombardeiros.
...
*Se um ativo de veículo da equipe for destruído, ele incorre em uma penalidade de multa:
...
* Os veículos são ** Team Locked ** e você não pode operar veículos inimigos de qualquer tipo.
* Veículos só podem ser inseridos ** de posições apropriadas ** no casco.
* Soldados normais têm permissão para dirigir pequenos veículos não blindados, como jipes, caminhões e barcos, sem a necessidade de qualquer kit especializado. Se você precisar de ** um tripulante ou kit piloto ** para operar a posição do veículo, você receberá uma mensagem de aviso ao entrar nela e a tela ficará preta. Se você não sair da posição do veículo dentro de alguns segundos, você morrerá.
...
* ** Os destroços de veículos destruidores ** não influenciam a pontuação, embora uma mensagem de aviso indique o contrário ao atirar em destroços amigáveis.
* Quando manejar ** armas estacionárias ou de veículos **, leva um tempo de aquecimento específico antes que eles tenham a capacidade de disparar:
  * MG: ** 5 segundos **
  * Míssil Anti-Ar: ** 5 segundos **
  * AT-emplacement: ** 10 segundos **
  * Armor main cannon: ** 30 segundos **
* A maioria das armas AT estacionárias tem ótica com capacidade de zoom fixo. Alguns deles até oferecem óptica térmica.
